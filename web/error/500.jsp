...
<script type="text/javascript">
	...
	function redirect(){
		...
		if(num<0){
			...
			<%--location.href='<c:url value="/reader/index.jsp"></c:url>';--%>
            	window.history.go(-1);
			}
		}
...
<div class="whole">
	<img src="<c:url value="/static/img/500view.jpg"></c:url>" />
    <div class="mask"></div>
</div>
<div class="b">
		<img src="<c:url value="/static/img/500.png"></c:url>" class="center"/>
		<p>
			抱歉...好像出现了奇怪的问题...<br>
