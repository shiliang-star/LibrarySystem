...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/reader/ReaderLogin.js"></script>
    <style type="text/css">
        .divForm{
        ...
        <div class="col-lg-12">
            ...
            <form class="bootstrap-admin-login-form" >
                <div class="form-group">
                    ...
                    <input type="text" value="0909" class="form-control" id="username" placeholder="学号"/>
