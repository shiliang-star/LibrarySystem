...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/js/getReaderBackInfo.js"></script>
                    ...
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        ...
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <form class="form-horizontal"
                                  action="${pageContext.request.contextPath}/reader/borrowInfoController_findMyBorrowInfoByPage.action"
                                  method="post">
                                <div class="row">
                                    <div class="col-lg-5 form-group">
                                        <label class="col-lg-4 control-label" for="borrowId"><label
                                                class="text-danger"></label>借阅编号</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" name="borrowId" type="text" value="${query.borrowId}"
                                                   placeholder="请输入借阅编号">
                                            <label class="control-label" for="borrowId" style="display: none"></label>
                                        </div>
                                    </div>
                                    <div class="col-lg-5 form-group">
                                        <label class="col-lg-4 control-label" for="ISBN"><label
                ...
                <div class="col-lg-12">
                    <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <c:if test="${requestScope.pb.list!=null}">
                            <c:forEach items="${requestScope.pb.list}" var="back">
                                <tbody>
                                <td><c:out value="${back.borrowId}"/></td>
                                <td><c:out value="${back.ISBN}"/></td>
                                <td><c:out value="${back.bookName}"/></td>
                                <td><c:out value="${back.paperNO}"/></td>
                                <td><c:out value="${back.readerName}"/></td>
                                <td><c:out value="${back.backDate}"/></td>
                                <td><c:out value="${back.endDate}"/></td>
                                <td>
                    ...
                    <script type="text/javascript">
                        function page(currentPage) {
                            window.location.href = "${pageContext.request.contextPath}/reader/borrowInfoController_findMyBorrowInfoByPage.action?currentPage=" + currentPage+
...
<form class="form-horizontal">   <!--保证样式水平不混乱-->
    <!-- 模态框（Modal） -->
    <div class="modal fade" id="findBackModal" tabindex="-1" role="dialog" aria-labelledby="checkModalLabel"
         aria-hidden="true">
