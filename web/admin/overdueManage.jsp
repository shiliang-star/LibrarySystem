...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/js/admin/overduemanager/pay.js"></script>
    <script src="${pageContext.request.contextPath}/static/js/getForfeitInfo.js"></script>
</head>
                    ...
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        ...
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <form class="form-horizontal"
                                  action="${pageContext.request.contextPath}/admin/overDueManageController_list.action"
                                  method="post">
                                <div class="row">
                ...
                <div class="col-lg-12">
                    <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <c:choose>
                            <c:when test="${pb.list != null }">
                                <c:forEach items="${pb.list }" var="forfeit">
                                    <tbody>
                    ...
                    <script type="text/javascript">
                        function page(currentPage) {
                            window.location.href = "${pageContext.request.contextPath}/admin/backManageController_list.action?currentPage=" + currentPage+
