...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/js/admin/backmanage/backBook.js"></script>
</head>
                    ...
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        ...
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <form class="form-horizontal"
                                  action="${pageContext.request.contextPath}/admin/backManageController_list.action"
                                  method="post">
                                <div class="row">
